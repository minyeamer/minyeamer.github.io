...
- **[구축 계기](#나만의-블로그를-만들게-된-계기)**: Velog, 티스토리 등 기존 플랫폼의 제약을 넘어 Hugo를 선택한 이유
- **[테마 선정 및 기획](#기본-테마-선정하기)**: Hugo Book 테마의 구조 분석과 사용자 중심의 기능 설계 전략 기획
- **[프로젝트 구성](#블로그-프로젝트-구성하기)**: 로컬 환경 설정부터 [GitHub Pages 연동](#4-github-pages-설정)을 위한 저장소 관리 기법
- **[배포 최적화](#5-submodule-구성)**: Submodule 기반의 브랜치 분리와 [한 번에 끝내는 배포 스크립트](#7-배포-스크립트-작성하기) 구현
{{% /hint %}}
