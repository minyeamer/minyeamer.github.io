...
tags: ["Hugo", "giscus", "Disqus", "utterances", "댓글 시스템", "GitHub Discussions", "SeoTax", "서택스 테마", "개발 블로그", "Blog"]
series: ["Hugo 테마 만들기"]
---
...
{{< image
  ...
  alt="giscus.app - 레포지토리 입력"
  max-width="700px"
  align="center" >}}

**Page ↔ Discussions Mapping** — 블로그 포스트와 Discussions을 어떻게 매핑할지 결정합니다.
...
{{< image
  ...
  alt="giscus.app - Discussion 카테고리 설정"
  max-width="700px"
  align="center" >}}
...
params:
  comments:
    giscus:
      ...
      repoId: "R_kgDOH7RTCQ"
      category: "Comments"
      categoryId: "DIC_kwDOH7RTCc4C9nE6"
      mapping: "pathname"
