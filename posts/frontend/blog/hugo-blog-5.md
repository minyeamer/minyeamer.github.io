---
title: "Hugo Disqus 댓글 연동 - 본문 레이아웃 개선하기 (헤더/푸터)"
...
- **[헤더 디자인 개선](#본문-헤더-개선하기)**: 블로그 제목과 카테고리를 [헤더에 배치](#본문-제목-추가하기)하고, [커버 이미지](#본문-커버-이미지-표시하기)로 게시글의 시각적 정체성 확립
- **[푸터 네비게이션 구축](#본문-푸터-개선하기)**: 시리즈 연속성을 고려한 [이전/다음 게시글 링크](#이전-다음-게시글-링크-추가하기)와 [태그 목록](#태그-목록-표시하기) 구현
- **[댓글 시스템 연동](#댓글-기능-추가하기-disqus)**: Disqus 플랫폼을 통한 소셜 댓글 기능으로 독자와의 양방향 소통 채널 확보
- **[UX 향상 요소](#기타-기능-추가하기)**: 읽기 진행률을 시각화하는 [스크롤 진행도](#스크롤-진행도-표시하기)와 사이드바의 [최신글 위젯](#최신글-표시하기) 으로 사용자 경험 극대화
{{% /hint %}}
