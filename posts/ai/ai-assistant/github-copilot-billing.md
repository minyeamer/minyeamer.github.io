...
layout: "post"
description: >
  GitHub Copilot이 2026년 6월 1일부터 Premium request 기반 요금제에서 AI credits 기반 사용량 청구로 전환됩니다.
  개인 계정의 2026년 3월부터 5월까지 실제 사용량 리포트를 분석해보고, 왜 Copilot을 이탈하는 결정을 했는지 안내합니다.
...
tags: ["GitHub Copilot", "Copilot 요금제", "AI credits", "사용량 기반 청구", "Premium Requests", "AI 코딩 에이전트", "VS Code"]
...
기존 Premium request 기준과 2026년 6월 1일부터 적용될 AI credits 기준을 비교했습니다.
기존 요청 기반 요금제에서는 추가 청구가 없었지만,
AI credits 기준으로 다시 계산하면 제 사용 방식은 월 $120~$190 정도의 비용으로 보였습니다.

- **[사용량 기반 청구 전환](#사용량-기반-청구-전환)**: Copilot 요금제가 왜 바뀌는지 먼저 정리합니다.
- **[Premium request와 AI credits](#premium-request에-대해)**: 기존 요청 기반 계산 방식과 새 과금 단위를 비교합니다.
- **[새 Copilot 요금제](#github-ai-credits)**: Pro, Pro+, Max의 포함 credits와 추가 사용량 방식을 봅니다.
- **[사용량 리포트 분석](#내-실제-사용량)**: 2026년 3월부터 5월까지의 사용량을 월별 비용으로 다시 계산합니다.
- **[이탈 결정과 대안](#copilot-이탈-결정)**: 왜 Copilot을 떠났는지와 다음에 비교할 도구를 정리합니다.
{{% /hint %}}
...
2026-05|$106.57|$101.57|$75.57|$100.00
{{% /data-table %}}
...
하지만, Github Copilot 자체가 프론티어 모델을 직접 제공하는 OpenAI Codex, Claude Code 등과
