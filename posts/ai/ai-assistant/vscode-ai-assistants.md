...
이 글은 제공 업체별 AI 모델의 벤치마크 성능 차이 또는 토큰 효율을 비교하기 위한 글이 아닙니다.
제가 주로 사용하는 VS Code 환경에서 확장 프로그램 형태로 제공되는 AI 코딩 에이전트가
얼마나 사용이 편리한지를 핵심 포인트로 다룹니다.
...
AI 코딩 에이전트|개인 저가 플랜|개인 기본 플랜|개인 상위 플랜|개인 프리미엄 플랜|제한 방식
GitHub Copilot|Pro $10/월|Pro+ $39/월|Max $100/월|\-|월간 AI credits 제공, 세션 제한, 주간 한도
OpenAI Codex|ChatGPT Go $8/월|ChatGPT Plus $20/월|ChatGPT Pro $100/월|ChatGPT Pro 20x $200/월|5시간 단위 + 주간 한도
Claude Code|\-|Claude Pro $20/월|Claude Max $100/월|Claude Max 20x $200/월|5시간 단위 + 주간 한도
Gemini Code Assist|Google AI Plus $7.99/월|Google AI Pro $19.99/월|Google AI Ultra $99.99/월|Google AI Ultra 20x $199.99/월|일/시간/분 단위 한도
{{% /data-table %}}

요금만 보면 GitHub, ChatGPT, Google AI에서 저가 요금제를 제공하고,
ChatGPT, Claude, Google AI에서 사용량을 증대시킨 프리미엄 요금제를 제공합니다.
같은 구독료를 결제하더라도 모델별 토큰 효율이 다르기 때문에 실제 사용량 기반으로 따져봐야 합니다.
...
![Codex 설치](https://dl.dropboxusercontent.com/scl/fi/6h2f05gxcju06y9kji3zl/vscode-02-codex-install.webp?rlkey=msjwesl1dwjbv2yawu12tr1os&raw=1)
...
필요성을 느끼지 못했습니다.
최근 Google AI 서밋을 통해 신규 모델들이 한 달 내에 사용할 수 있을 것이라 알려졌지만,
모델 성능 이전에 채팅창 위치에서 오는 불편함 때문에 더 이상 이해하고 싶지 않았습니다.
